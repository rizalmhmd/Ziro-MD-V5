...
global.titlebot = `𝙕𝘼𝙇𝙇𝙭𝘽𝙊𝙏𝙕 | 𝚉𝚊𝚕𝚕` //ganti aja
global.stickpack = '𝙕𝘼𝙇𝙇𝙭𝘽𝙊𝙏𝙕' //ganti 
global.stickauth = `© 𝚉𝚊𝚕𝚕` //gantii 
global.week = `${week} ${date}` //Gak usah
global.wibb = `${wktuwib}` // Gak usah 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= '𝚉𝚊𝚕𝚕' //ganti 
...
global.wame = 'https://wa.me/6281333154367' //Tautan Wa Kalian
...
global.ultahowner = 'JULI 35 2023' //ultah luh 😭
